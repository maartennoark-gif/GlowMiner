...
::
:: Fields:
::      algo - the name of the algorithm to run. E.g. karlsen or autolykos2.
...
teamredminer.exe -a karlsen -o stratum+tcp://kls.kryptex.network:7777 -u karlsen:qzzae4rwyf78hvhhqwksajyaumy74me4rs8qghzsw7qayshj9c5fxjph5m0nc/trmtest -p x
