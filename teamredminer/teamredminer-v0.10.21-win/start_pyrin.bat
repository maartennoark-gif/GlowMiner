...
::
:: Fields:
::      algo - the name of the algorithm to run. E.g. pyrin or autolykos2.
...
teamredminer.exe -a pyrin -o stratum+tcp://de.pyrin.herominers.com:1177 -u pyrin:qq54286p823r9yza6cudqavf47a62m2qstseumhdc7kspver328ucq96f6ya2.trmtest -p x
